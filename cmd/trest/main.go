...
import (
	...
	"github.com/mintfary-oss/trest-sistems/internal/proektirovka/generator"
...
func newGenerateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "generate",
		Short: "Generate GOST architectural DXF drawings",
		RunE: func(cmd *cobra.Command, args []string) error {
			return generator.Generate(configPath, outDir)
		},
	}
	cmd.Flags().StringVar(&configPath, "config", "proektirovka-sdaniy/configs/court_tosno.yaml", "building YAML config")
